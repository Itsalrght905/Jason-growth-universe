...
export default function MathPlanet({state,onComplete,onHome,onRecord}){
  ...
  return <><div className="page-intro blue-bg"><span>🪐</span><p className="eyebrow">数学星球</p><h1>数字探险开始啦</h1><p>完成 5 道题，就能带着星星回家。</p></div><QuestionCard key={round} item={question} index={round} total={5} onNext={next} onRecord={onRecord}/></>
}
